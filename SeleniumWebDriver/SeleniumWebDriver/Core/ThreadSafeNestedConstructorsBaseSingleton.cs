...
{
    public abstract class ThreadSafeNestedConstructorsBaseSingleton<T>
    {
        ...
        internal static class SingletonFactory
        {
            ...
            public static T CreateInstance(Type type)
            {
                ...
                {
                    throw new Exception(string.Concat(type.FullName, " has one mpre public constructors so the property cannot be enforced."));
                }
